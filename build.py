...
def get_personal_data():
    ...
    bio_text = f"""
                ...
                <p>
                    ...
                    Dr. Fangtian Zhong is an incoming assistant professor. He received a Ph.D. in Computer Science from <a href="https://www.gwu.edu/" target="_blank">George Washington University</a> in 2021. After graduation, he worked as a postdoctoral scholar at <a href="https://www.psu.edu/" target="_blank">Pennsylvania State University</a> and <a href="https://www.nd.edu/" target="_blank">University of Notre Dame</a>. His research primarily focuses on software security, program analysis, and machine 
                    learning for cybersecurity. He enjoys developing novel and beautiful solutions to software security issues in different architectures, especially native codes without a source. He is a recipient of Graduate Fellowship and Graduate Merit Award at GWU. Outside of work, he likes exploring outdoor sports and playing CTF or DEFCON.
                ...
                <p>
                    ...
                    I have multiple RA/TA positions in my research group. If you are interested in pursuing a Ph.D. degree for a research career, please contact me for further information. Visting scholars, research interns, graduate students and undergraduate students are also welcome.
                </p>
                <!--
                <p>
                ...
                <p>
                    <a href="cv.html" target="_blank" style="margin-right: 15px"><i class="fa fa-address-card fa-lg"></i> CV</a>
                    <a href="mailto:squareky_zhong@gwu.edu" style="margin-right: 15px"><i class="far fa-envelope-open fa-lg"></i> Mail</a>
                    <a href="https://twitter.com/Fangtian_Zhong" target="_blank" style="margin-right: 15px"><i class="fab fa-twitter fa-lg"></i> Twitter</a>
    ...
    PhD students with full scholarship, including tuition fees and stipends. <br> </p> </div>"""
...
def get_publications_html():
    ...
    bib_data = parser.parse_file('publication_list_zhong.bib')
...
def get_talks_html():
    parser = bibtex.Parser()
    bib_data = parser.parse_file('talk_list_zhong.bib')
    keys = bib_data.entries.keys()
    s = ""
    for k in keys:
