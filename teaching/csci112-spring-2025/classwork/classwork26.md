...
## Logistics
* Due: Wednesday, April 16th AoE.
* Submission instructions: make sure that the required file (`realloc.c`) is in your
	`csci112_spring2025/classwork/week14/wed/` directory.
...
* From your home directory, navigate to `csci112_spring2025/classwork/week14/wed/`, creating directories `week14`
and `wed` if necessary.
* Copy the file `/public/classwork/week14/wed/realloc.c` into your directory.
...
```
[g73x595@csci112 wed]$ gcc realloc.c -Wall
