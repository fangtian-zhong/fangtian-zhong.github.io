...
After I complile your source code files individually, the IDE will produce the executable files.
    ...
    You can add the following codes to your project1. `Note`: Running program2.exe before attaching and after attaching will produce different results, since the file headers and section layout will change once program1.exe is appended.
