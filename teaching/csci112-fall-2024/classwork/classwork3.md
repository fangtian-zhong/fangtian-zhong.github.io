...
## Logistics
* Due: Monday, January 22th AoE (Tuesday 6am Bozeman time).
* Submission instructions: make sure that the required file (`hello_world.c`) is in your
	`csci112_spring2024/classwork/week2/mon/` directory.
...
* From your home directory, navigate to `csci112_spring2024/classwork/week2/mon/` creating directories `week2` and `mon` if necessary.
